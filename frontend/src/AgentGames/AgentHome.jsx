      ...
      <section className="bg-gradient-to-br from-league-blue to-primary py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-league-text max-w-3xl mx-auto mb-10">
            A modern platform for developing, testing, and competing with intelligent agents in strategic games.
          </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-ui-dark mb-2">Learn to Design Algorithms</h3>
              <p className="text-ui">
                Build agents that make strategic decisions, developing algorithmic thinking and problem-solving skills through interactive challenges.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-ui-dark mb-2">Compete & Improve</h3>
              <p className="text-ui">
                Test your agents against others in competitive leagues, gaining insights and refining your strategies with each iteration.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-14 h-14 rounded-full bg-notice-yellowBg flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-notice-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-ui-dark mb-2">Easy or Free</h3>
              <p className="text-ui">
                The platform is open source - clone the GitHub repo and host it yourself, or sign up for an affordable, hassle-free institution account.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-ui-lighter p-6 rounded-lg shadow-md">
              <div className="mb-4 rounded overflow-hidden">
                <img src="games/greedy_pig.png" alt="Greedy Pig game" className="w-full h-48 object-cover" />
              </div>
              <h3 className="text-xl font-semibold text-ui-dark mb-2">Greedy Pig</h3>
            ...
            <div className="bg-ui-lighter p-6 rounded-lg shadow-md">
              <div className="mb-4 rounded overflow-hidden">
                <img src="games/prisoners_dilemma.png" alt="Prisoner's Dilemma game" className="w-full h-48 object-cover" />
              </div>
              <h3 className="text-xl font-semibold text-ui-dark mb-2">Prisoner's Dilemma</h3>
              <p className="text-ui mb-4">
      ...
      <section className="py-16 bg-league-blue text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-center">For Educational Institutions</h2>
            <p className="text-lg mb-8 text-league-text text-center">
              Agent Games provides a powerful platform for teaching programming, algorithmic thinking, and computational concepts in a competitive and engaging environment.
            </p>
            <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
              <h3 className="text-xl font-semibold mb-4">Benefits for Schools and Universities:</h3>
              <ul className="space-y-3 text-league-text">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Ready-to-use platform with structured competitions and leagues</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Comprehensive dashboard for managing student teams and viewing results</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Automatic evaluation and feedback for student submissions</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-success mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Self-hosted option available for schools with specific requirements</span>
                </li>
              </ul>
