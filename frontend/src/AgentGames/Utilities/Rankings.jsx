  ...
  return (
    <>
      <div className="main-container">
        <select onChange={handleDropdownChange}>
          {allRankings.map((league, index) => (
            <option key={index} value={league.league_name} style={{ color: moment().isBefore(moment(league.expiry_date)) ? 'green' : 'red' }}>
      ...
      <div className="output-container">
        {rankingOutput ? (<ResultsDisplay data={rankingOutput} />) : (<p>Loading results...</p>)}
      </div>
    </>
  );
}
