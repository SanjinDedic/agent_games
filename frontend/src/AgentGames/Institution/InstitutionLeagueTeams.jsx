...
const InstitutionLeagueTeams = ({ selected_league_name }) => {
    ...
    useEffect(() => {
        ...
        const newUnassignedTeams = teams.filter(value => !value.league || value.league === "unassigned");
    ...
    return (
        <div className="w-full">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-ui-dark">Teams in League</h2>
                <button
...
export default InstitutionLeagueTeams;