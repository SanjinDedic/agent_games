...
const GreedyPigPlayerFeedback = ({ playerData }) => {
    ...
    return (
        <div className="mt-6 mb-4">
            {playerData.map((player, playerIdx) => (
                <div key={playerIdx} className="bg-ui-lighter rounded-lg p-4 mb-3">
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-lg font-medium text-ui-dark">
                            Feedback from {player.name}
                        </h3>
                        {player.player_feedback?.length > 0 && (
                            <button
                    ...
                    `}>
                        <div className="space-y-2">
                            {player.player_feedback.map((feedback, index) => (
...
export default GreedyPigPlayerFeedback;
