...
function AgentGamesNavbar() {
  ...
  const adminRoutes = ['/AdminTeam', '/AdminLeague', '/AdminDockerStatus', '/AdminDemoUsers'];
      ...
      <div className="w-full mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex-1 flex items-center justify-around">
            {isAdminRoute ? (
              ...
              <>
                ...
                <Link to="/Institutions" className={navLinkClasses}>
                  Institutions
                </Link>
          ...
          <div className="flex items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512" className="w-5 h-5 mr-2">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium">SanjinDedic/agent_games</span>
            ...
            {!isAdminRoute && currentUser && currentUser.role === 'student' && (
              <Button
                variant="danger"
